...
Projeto desenvolvido para a disciplina de Sistemas Operacionais e POO, com foco em **concorrência, sincronização de processos, leitores e escritores, prioridade, starvation, deadlock e race condition**.
...
Projeto funcional para demonstração dos conceitos de concorrência e sincronização em Sistemas Operacionais e Programaçao Orientada a Objetos.
