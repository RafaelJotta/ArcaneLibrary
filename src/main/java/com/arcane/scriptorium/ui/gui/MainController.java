package com.arcane.scriptorium.ui.gui;
...
public class MainController implements SimulationObserver {
    ...
    private void carregarImagens() {
        try {
            imgLivro = new Image(getClass().getResourceAsStream("/com/arcane/scriptorium/ui/gui/assets/livro.png"));
            imgMagoComum = new Image(getClass().getResourceAsStream("/com/arcane/scriptorium/ui/gui/assets/mago_azul.png"));
            imgMagoCritico = new Image(getClass().getResourceAsStream("/com/arcane/scriptorium/ui/gui/assets/mago_roxo.png"));
            imgMagoEscritor = new Image(getClass().getResourceAsStream("/com/arcane/scriptorium/ui/gui/assets/mago_vermelho.png"));
        } catch (Exception e) {
